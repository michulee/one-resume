...
import {TextInput, SectionHeader, Layout, TextArea, NavContents, Nav, ButtonRound} from 'components/index';

const SectionBasicContents = styled.div`
  display: flex;
